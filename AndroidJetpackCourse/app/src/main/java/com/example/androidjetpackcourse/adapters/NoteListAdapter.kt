...
import com.example.androidjetpackcourse.view.activities.RoomActivity
    ...
    inner class NoteViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun setListeners() {
            itemView.setOnClickListener {
                ...
                (mContext as Activity).startActivityForResult(intent, RoomActivity.UPDATE_NOTE_ACTIVITY_REQUEST_CODE)
            }
