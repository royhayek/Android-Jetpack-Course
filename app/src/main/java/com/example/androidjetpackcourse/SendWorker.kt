package com.example.androidjetpackcourse
...
import com.example.androidjetpackcourse.view.activities.WorkManagerActivity
...
class SendWorker(context: Context, parameters: WorkerParameters) : Worker(context, parameters) {
    ...
    override fun doWork(): Result {
        ...
        val taskDataString = taskData.getString(WorkManagerActivity.MESSAGE_STATUS)
